...
<<hcl-properties, fig.width = 4, fig.height = 2.2, out.width = "\\textwidth">>=
swatchplot(
...
<<rgb-properties, fig.width = 3.6, fig.height = 2.2, out.width = "\\textwidth">>=
swatchplot(
  "Red"       = rgb(0:4/4, 0, 0),
  "Green"     = rgb(0, 0:4/4, 0),
  "Blue"      = rgb(0, 0, 0:4/4),
...
<<swatchplot-r4, fig.height = 4.5, fig.width = 5.75, echo = TRUE, out.width = "0.46\\textwidth">>=
...
<<swatchplot-okabeito, fig.height = 4.5, fig.width = 5.75, echo = TRUE, out.width = "0.46\\textwidth">>=
...
<<hclplot-plot, fig.width = 15, fig.height = 5, dev = "png", out.width = "\\textwidth">>=
par(mfrow = c(1, 3))
hclplot(qualitative_hcl(7, palette = "Set 2"))
hclplot( sequential_hcl(7, palette = "Blues 3"))
hclplot(  diverging_hcl(7, palette = "Blue-Red"))
...
<<demoplot, fig.width = 15, fig.height = 6, out.width = "\\textwidth">>=
par(mfrow = c(2, 5))
