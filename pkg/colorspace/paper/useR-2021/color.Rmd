...
The following sections describe the new color palettes in more detail.
...
function returns a character vector of the available palette names and Figure
\@ref(fig:newPalettes) shows swatches for each of the
available palettes.
