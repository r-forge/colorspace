...
```{r colorcat, echo=FALSE, fig.height=4, fig.width=6.6, fig.show = 'hide'}
library("ggplot2")
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.63\textwidth]{color_files/figure-latex/colorcat-1} 
\hfill
\includegraphics[width=0.27\textwidth]{color_files/figure-latex/colorcont-1}
