...
```{r viridishcl, echo=FALSE, fig.width=5, fig.height=4, out.width='.6\\textwidth', fig.align='center', fig.pos='t!', fig.cap='Hue, Chroma, and Luminance paths for the `"Blues 3"` palette.'}
library(colorspace)
...
while using the same chroma and luminance for all their colors.
