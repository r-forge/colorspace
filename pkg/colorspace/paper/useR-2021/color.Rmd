...
These provided the default
  ...
  palette we will instead represent the vector of R colors by a "swatch"
  of rectangles filled with the corresponding colors.

  ```{r oldDefault, echo=FALSE, fig.width=2, fig.height=.5}
...
The functions `heat.colors()`, `terrain.colors()`, `topo.colors()`, and 
  ...
  ```{r oldSequential, echo=FALSE, fig.width=6, fig.height=1}
  paletteGrids(list("heat.colors(10)"=heat.colors(10), 
                    "topo.colors(8)"=topo.colors(8),
                    "terrain.colors(9)"=terrain.colors(9), 
                    "gray.colors(6)"=gray.colors(6)))
  ```
...
The function `cm.colors()` also generates `n` colors.
  ...
  ```{r oldDiverging, echo=FALSE, fig.width=2, fig.height=.5}
  grid.newpage()
  paletteGrids(list("cm.colors(8)"=cm.colors(8)))
  ```
...
The function `rainbow()` also generates `n` colors.
  ...
  ```{r oldRainbow, echo=FALSE, fig.width=2, fig.height=.5}
  grid.newpage()
  paletteGrids(list("rainbow(10)"=rainbow(10)))
  ```
...
```{r oldbase, eval=FALSE, echo=FALSE, fig.height=1.75, fig.width=13, out.width='\\textwidth', fig.align='center', fig.pos='t!', fig.cap='Old base R palettes.'}
...
and the new, "R4" default palette are shown below.
...
```
  ```{r oldvsnew, echo=FALSE, fig.width=6, fig.height=1}
...
for all viewers.
  ...
  ```{r okabeito, echo=FALSE, fig.width=2, fig.height=.5}
...
and remind us how bad things used to be.
  ...
  ```{r r3, echo=FALSE, fig.width=2, fig.height=.5}
  ...
  ```{r otherssystems, echo=FALSE, fig.width=6, fig.height=.5}
  ...
  ```{r colorbrewer, echo=FALSE, fig.width=6, fig.height=2}
  ...
  ```{r polychrome, echo=FALSE, fig.width=6, fig.height=3}
