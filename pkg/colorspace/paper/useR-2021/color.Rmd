...
The output below shows what R used to produce prior to version 4.0.0.
...
from the `"R4"` palette (the new default provided by `palette()`).
...
The details always also depend a lot on how many colors we need. For
