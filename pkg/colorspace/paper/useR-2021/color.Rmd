...
comparing the old `"R3"` default color palette with
the new `"R4"` default and a new `"Okabe-Ito"` qualitative 
palette @Okabe+Ito:2008
that can be selected using `palette.colors()`.
The first row shows the `"R3"` default;  the second column shows
an emulation of a kind of red-green
color blindness known as protanopia using the \pkg{colorspace} package 
...
Futhermore, for protanope viewers, the 
DAX and the SMI lines are difficult to 
distinguish from each other and the American FTSE line is difficult to
distinguish from the white background.

The `"R4"` palette is an improvement:  the luminance is more even and
the colors are less saturated, plus the colors are more
distinguishable for protanope viewers. 
The `"Okabe-Ito"` palette also works better than `"R3"`,
particularly for protanope viewers.
...
tsplot(palette = "R3", protan = FALSE, legend = FALSE, main = "Normal")
tsplot(palette = "R3", protan = TRUE, legend = FALSE, main = "Protanope")
par(mar = c(5, 4, 1, 1))
...
(and infamously misinterpreted by a former President of The United States). 
The top row shows the original image along with an emulation of 
protanopia in the second column.
...
during hurricane Dorian in 2019.  The probabilities are highest
...
protanope viewers, plus any benefit of a red (danger!) to green (safe)
...
and monotonic changes in saturation.  The protanope version retains both
of these qualities.
...
```{r blues3hcl, echo=FALSE, fig.width=5, fig.height=4, out.width='.6\\textwidth', fig.align='center', fig.pos='t!', fig.cap='Hue, Chroma, and Luminance paths for the `"Blues 3"` palette.'}
library(colorspace)
...
```{r qualPalettes, echo=FALSE, fig.width=6, fig.height=7, out.width='\\textwidth', fig.align='center', fig.pos='ht!', fig.cap='Qualitative palettes.'}
...
```{r singleSeqPalettes, echo=FALSE, fig.width=6, fig.height=7, out.width='\\textwidth', fig.align='center', fig.pos='ht!', fig.cap='Single-hue sequential palettes.'}
...
```{r multiSeqPalettes, echo=FALSE, fig.width=6, fig.height=8, out.width='\\textwidth', fig.align='center', fig.pos='ht!', fig.cap='Multi-hue sequential palettes.'}
single <- rownames(hcl_palettes("sequential (single-hue)"))
pals <- hcl.pals("sequential")
...
```{r multiSeqPalettes2, echo=FALSE, fig.width=6, fig.height=8, out.width='\\textwidth', fig.align='center', fig.pos='ht!', fig.cap='Multi-hue sequential palettes.'}
single <- rownames(hcl_palettes("sequential (single-hue)"))
pals <- hcl.pals("sequential")
multiPals <- pals[! pals %in% single]
args <- lapply(multiPals,
...
```{r diverPalettes, echo=FALSE, fig.width=6, fig.height=7, out.width='\\textwidth', fig.align='center', fig.pos='ht!', fig.cap='Diverging palettes.'}
...
```{r diverxPalettes, echo=FALSE, fig.width=6, fig.height=7, out.width='\\textwidth', fig.align='center', fig.pos='ht!', fig.cap='Flexible diverging palettes.'}
