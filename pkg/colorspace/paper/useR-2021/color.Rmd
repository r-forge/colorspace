...
receive the same perceptual weight.  The palettes that maintain a 
high chroma throughout, such as `"Viridis"`, are also more effective
when we need to match specific colours to a legend or across several
...
+----------+---------------------------------------+-------------------------------------+-----------------------------------------------+
|_Robust_  | `"R4"`, `"Okabe-Ito"`                 | `"Blues 3"`, `"Viridis"`            | `"Purple-Green"`, `"Blue-Red 3"`              |
|          |                                       |                                     |                                               |
+----------+---------------------------------------+-------------------------------------+-----------------------------------------------+
