...
\author{\vspace*{-6.3cm}\hspace*{12.5cm}\includegraphics[width=1.6cm]{../EGU2020/palmfooter.png}\\[4.7cm]} %% -6.83 with "for Statistical Graphics"
...
\textbf{Qualitative:} Fixed chroma/luminance too balanced for color vision deficiencies.
...
\subsection{colorspace package}

\begin{frame}
\frametitle{colorspace package}
...
\author{\vspace*{-5.9cm}\hspace*{12.5cm}\includegraphics[width=1.6cm]{../EGU2020/palmfooter.png}\\[4.7cm]}
\URL{}
\section{Links}
